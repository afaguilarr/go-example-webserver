...
type EncryptRequest struct {
	...
	UnencryptedValue []byte `protobuf:"bytes,2,opt,name=unencrypted_value,json=unencryptedValue,proto3" json:"unencrypted_value,omitempty"`
}
...
func (x *EncryptRequest) GetUnencryptedValue() []byte {
	if x != nil {
...
func (x *EncryptResponse) GetEncryptedValue() []byte {
	if x != nil {
...
func (x *DecryptRequest) GetEncryptedValue() []byte {
	if x != nil {
		return x.EncryptedValue
	}
	return nil
...
type DecryptResponse struct {
	...
	DecryptedValue []byte `protobuf:"bytes,1,opt,name=decrypted_value,json=decryptedValue,proto3" json:"decrypted_value,omitempty"`
}
...
func (x *DecryptResponse) GetDecryptedValue() []byte {
	if x != nil {
...
var file_proto_crypto_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x65, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
	...
	0x65, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e,
	...
	0x01, 0x28, 0x0c, 0x52, 0x0e, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x56, 0x61,
	...
	0x74, 0x65, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
